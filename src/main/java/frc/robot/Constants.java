...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double METERS_PER_ROT = WHEEL_DIAMETER / GEAR_RATIO;
    ...
    public static final double MAX_ANG_SPEED = MAX_MODULE_SPEED / SIDE_LENGTH * 2;
    public static final double MAX_ANG_INPUT = 3.0;
  }

  public static final class Field {
    public static final double FIELD_LENGTH = 16.54;
    public static final double SPEAKER_Y = 5.53;
  }
  ...
  public static final class Port {
    ...
    public static final int LEFT_CLIMB_LIMIT = 2;
    public static final int RIGHT_CLIMB_LIMIT = 1;
    public static final int TRANSPORT_LIMIT = 3;
