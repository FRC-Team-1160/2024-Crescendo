...
public class SwerveDriveSpeedAuto extends Command {
    ...
    public SwerveDriveSpeedAuto(DriveTrain m_drive, double x, double y, double max_v, double max_a, double p_override){
    ...
    public void initialize(){
        ...
        x_pid = new PIDController(p_override, 0, 0);
        y_pid = new PIDController(p_override, 0, 0);
    ...
    public boolean isFinished(){
        return (Math.sqrt(Math.pow(m_drive.odomPose.getX() - target_x, 2) + Math.pow(m_drive.odomPose.getY() - target_y, 2)) < 0.2);
    }
